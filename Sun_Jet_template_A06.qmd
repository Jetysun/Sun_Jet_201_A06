...
Colorado$median <- apply(Colorado[2:14], 1, median)

CO_max_index <- which.max(CO_median_annual_temps)
CO_min_index <- which.min(CO_median_annual_temps)

CO_max_year <- which.max(CO_median_annual_temps) + 1894
CO_min_year <- which.min(CO_median_annual_temps) + 1894

CO_max_temp <- CO_median_annual_temps[CO_max_index]
CO_min_temp <- CO_median_annual_temps[CO_min_index]

print(paste0("The maximum median annual temperature of ", CO_max_temp,  " occurred in ", CO_max_year, " and the minimum median annual temperature of ", CO_min_temp, " occurred in ", CO_min_year, " ."))
```
